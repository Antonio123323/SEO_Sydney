...
# Route to handle beleggen-via-vennootschap page
@app.route('/beleggen-via-vennootschap')
def beleggen_via_vennootschap():
    return render_template('beleggen-via-vennootschap/index.html')

# Route to handle beleggen-voor-kinderen page
@app.route('/beleggen-voor-kinderen')
def beleggen_voor_kinderen():
    return render_template('beleggen-voor-kinderen/index.html')

# Route to handle beste-beleggen-cursussen-belgie page
@app.route('/beste-beleggen-cursussen-belgie')
def beste_beleggen_cursussen_belgie():
    return render_template('beste-beleggen-cursussen-belgie/index.html')

# Route to handle crypto-beleggen-voor-beginners page
@app.route('/crypto-beleggen-voor-beginners')
def crypto_beleggen_voor_beginners():
    return render_template('crypto-beleggen-voor-beginners/index.html')

# Route to handle veilig-beleggen-in-goud page
@app.route('/veilig-beleggen-in-goud')
def veilig_beleggen_in_goud():
    return render_template('veilig-beleggen-in-goud/index.html')
...
def sitemap():
    ...
    base_url = 'https://smartfinancebe.com'  # Replace with your actual domain
